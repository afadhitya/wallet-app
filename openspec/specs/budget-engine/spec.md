...
Provide budget management capabilities to the wallet CLI — users can set, edit, list, check, and remove budgets with category/tag targeting, period-based spending tracking, and recurring auto-generation.
