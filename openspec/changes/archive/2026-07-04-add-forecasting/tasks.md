...
- [x] 2.5 Add service tests for default horizon, multi-month recurrence expansion, account filtering, invalid months, no planned payments, and negative-balance warnings.
